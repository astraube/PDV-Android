...
import com.autazcloud.pdv.domain.models.impl.ProductImpl;
 ...
 */
public class Product extends RealmObject implements ProductInterface {
    ...
    /*public Product(String createdAt, String updatedAt, String publicToken, String name, String description, String codeCorporate, String codeEan, double priceCost, double priceResale, double discount, int requestPass, int stockCurrent, int stockMin, int stockMax, long categoryId, RealmList<RealmObject> values, Category category) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(createdAt, rhs.createdAt).append(updatedAt, rhs.updatedAt).append(publicToken, rhs.publicToken).append(name, rhs.name).append(description, rhs.description).append(codeCorporate, rhs.codeCorporate).append(codeEan, rhs.codeEan).append(priceCost, rhs.priceCost).append(priceResale, rhs.priceResale).append(requestPass, rhs.requestPass).append(categoryId, rhs.categoryId).append(values, rhs.values).append(category, rhs.category).isEquals();
    }*/
